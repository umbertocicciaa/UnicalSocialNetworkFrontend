...
export class FollowerService extends BaseService {
   ...
   */
  follow$Response(params: Follow$Params, context?: HttpContext): Observable<StrictHttpResponse<FollowerCreatedResponse>> {
   ...
   * This method sends `application/json` and handles request body of type `application/json`.
   */
  follow(params: Follow$Params, context?: HttpContext): Observable<FollowerCreatedResponse> {
    return this.follow$Response(params, context).pipe(
      map((r: StrictHttpResponse<FollowerCreatedResponse>): FollowerCreatedResponse => r.body)
    );
  }

  /** Path part for operation `isFollowing()` */
  static readonly IsFollowingPath = '/api/v1/Follower/following/{user}/{userToFollow}';
   ...
   */
  isFollowing$Response(params: IsFollowing$Params, context?: HttpContext): Observable<StrictHttpResponse<IsFollowingResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  isFollowing(params: IsFollowing$Params, context?: HttpContext): Observable<IsFollowingResponse> {
    return this.isFollowing$Response(params, context).pipe(
      map((r: StrictHttpResponse<IsFollowingResponse>): IsFollowingResponse => r.body)
    );
  }

  /** Path part for operation `countFollowing()` */
  static readonly CountFollowingPath = '/api/v1/Follower/following-total/{user_id}';
   ...
   * This method doesn't expect any request body.
   */
  countFollowing$Response(params: CountFollowing$Params, context?: HttpContext): Observable<StrictHttpResponse<FollowingNumberResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  countFollowing(params: CountFollowing$Params, context?: HttpContext): Observable<FollowingNumberResponse> {
    return this.countFollowing$Response(params, context).pipe(
      map((r: StrictHttpResponse<FollowingNumberResponse>): FollowingNumberResponse => r.body)
    );
  }

  /** Path part for operation `countFollowers()` */
  static readonly CountFollowersPath = '/api/v1/Follower/followers-total/{user_id}';
   ...
   * This method doesn't expect any request body.
   */
  countFollowers$Response(params: CountFollowers$Params, context?: HttpContext): Observable<StrictHttpResponse<FollowerNumberResponse>> {
   ...
   * This method doesn't expect any request body.
   */
  countFollowers(params: CountFollowers$Params, context?: HttpContext): Observable<FollowerNumberResponse> {
    return this.countFollowers$Response(params, context).pipe(
      map((r: StrictHttpResponse<FollowerNumberResponse>): FollowerNumberResponse => r.body)
    );
  }
